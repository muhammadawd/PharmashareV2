...
@section("body")
    ...
    <div class="wrapper">
        @include("pages.offers.offerPackages.templates.top_header")
        @include("pages.offers.offerPackages.templates.center_content")
    </div>
        ...
        function deleteAdsImagePackage(id) {
            swal({
                ...
                if (result) {
                    $.ajax({
                        method: 'delete',
                        url: '{{route('deleteAdsImagePackage')}}',
                        data: {
                            _token: '{{csrf_token()}}',
                            id: id
                        },
