...
@section("styles")
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3&key={{env("GOOGLE_MAP_API")}}&amp;sensor=false&amp;libraries=geometry"></script>
...
@section("body")
    ...
    <div class="wrapper">
        @include("pages.setting.editProfile.templates.top_header")
        @include("pages.setting.editProfile.templates.center_content")
    </div>
...
@section("scripts")
    ...
    <script>
        ...
        map.addControl(new MapboxGeocoder({
            ...
            zoom: 14,
            class: "form-control",
            placeholder: "{{__('auth.write_location')}}"
        }));
        ...
        function addMarker(e) {
            ...
            // $.ajax({
            //     url: 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+e.lngLat.lat+','+e.lngLat.lng+'&key={{env("GOOGLE_MAP_API")}}', 
            //     type: "get",    
            //     dataType: 'json',
            //     success: function(response){                          
            //         console.log(response);                   
