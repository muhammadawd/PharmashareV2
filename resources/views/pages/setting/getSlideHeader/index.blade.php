...
@section("body")
    ...
    <div class="wrapper">
        @include("pages.setting.getSlideHeader.templates.top_header")
        @include("pages.setting.getSlideHeader.templates.center_content")
    </div>
        ...
        function showMyImage(fileInput) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                reader.onload = function (e) {
                    ...
                    data.append('slide_id','{{$slide->id}}');
                    data.append('file', files[0]);
                    let image = this.result;
                    setTimeout(() => {
                        $.ajax({
                            method: 'POST',
                            url: '{{route('handleHeaderUpdateImage')}}',
