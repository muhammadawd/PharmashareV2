    ...
    <div class="container-fluid">
        <div class="button-container" style="margin-top: -121px">
            <ul class="list-unstyled list-inline ">
                ...
                <li class="list-inline-item">
                    ...
                    <h4 class="mt-1 cart-active">{{__('pharmacy.shipping')}}    </h4>
                </li>
                <li class="list-inline-item">
                    <div class="cart-path">
                        <h2 class="text_h2_gradient">3</h2>
                    </div>
                    <h4 class="mt-1">  {{__('pharmacy.checkout')}} </h4>
                </li>
            </ul>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-2 p-0">
                @if(in_array('payment',(array)$allowed_ads))
            ...
            <div class="col-md-8 text-center mt-4">
                @include("pages.shopping.shipping.templates.center_side")
            </div>
            <div class="col-md-2 p-0">
                @if(in_array('payment',(array)$allowed_ads))
