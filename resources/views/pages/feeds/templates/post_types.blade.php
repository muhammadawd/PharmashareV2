                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <h4 class="card-title mt-0 text-left text-capitalize">
                            ...
                            @endif
                            <br/>
                            <span class="badge badge-default" style="font-size:10px">{{$post->user->role->title ?? ''}}</span>
                            <br/>
                    ...
                    @if($post->user_id == $user->id || $user->role_id == 1)
                        <div class="col-2">
                            <div class="dropdown direction">
                                ...
                                <div class="dropdown-menu {{app()->getLocale() == 'en' ? 'left-menu' :''}}"
                                     data-placement="{{app()->getLocale() == 'ar' ? 'right' : 'left'}}">
                        ...
                        <div class="description">
                            ...
                            @if($post->post_type == 'link')
                                <h5 class="text-left link-overflow"> 
                                    <a href="{{$post->link}}" class="text-info" target="_blank">
                                        {{$post->link}}
                                    </a>
                                    @php
                                ...
                                <a href="{{$post->link}}" target="_blank">
                                    <div class="row" style="border: 1px solid #d4d4d4;border-radius: 15px;">
                                            ...
                                            <div class="col-10 text-left">
                                                <h4>{{$tags['author'] ?? $title ?? ''}}</h4>
                                                <div class="link-overflow" style="font-size:12px">{{$post->link}}</div>
                                                <h5 style="color:#111">{{$tags['description'] ?? ''}}</h5>
                                            </div>
                                    </div>
                                </a>
                            @endif
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="media like_avatars">
                                                                        @foreach($post->likes->sortByDesc("updated_at")->take(2) as $like)
                                                                            <a href="{{route('getUserProfileView',['username'=>'@'.$like->user->username , 'id'=>$like->user->id])}}"
                                                                               class="avatar m-0"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="comment"
                                                                                   class="form-control"
                                                                                   autocomplete="off"
                                                                                   placeholder="{{__('profile.comment_here')}}">
                                                                        </div>
                                                                        {{Form::close()}}
                                                                    </div>
                                                                @endcan
                                                                                        ...
                                                                                        <div class="card-body p-2">
                                                                                            ...
                                                                                            @foreach($post->comments as $comment)
                                                                                                ...
                                                                                                <div id="comment_{{$comment->id}}"
                                                                                                    ...
                                                                                                    <div class="media">
                                                                                                        <a class="float-left"
                                                                                                           href="{{route('getUserProfileView',['username'=>'@'.$comment->user->username , 'id'=>$comment->user->id])}}">
                                                                                                            <div class="avatar">
