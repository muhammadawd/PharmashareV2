...
@section("body")
    ...
    <div class="wrapper">
        @include("pages.profile.add-to-favourites.templates.top_header")
        @include("pages.profile.add-to-favourites.templates.center_content")
        @include("pages.profile.add-to-favourites.templates.update_product_modal")
    </div>
...
@section("scripts")
    ...
    <script>
        $(function () {
            ...
            added_to_favourites.push(parseInt('{{$item}}'));
            @endforeach
            ...
            jQuery(document).ready(function ($) {
                ...
                var engine = new Bloodhound({
                    remote: {
                        url: '{{route('getStoreAutoCompleteDrugs')}}' + '?drug_name=%QUERY%',
                        wildcard: '%QUERY%'
                    },
            ...
            function addnotify() {
                ...
                $.growl({
                    message: `<b>  {{app()->getLocale() == 'ar' ? 'تم الاضافة الى السلة' : 'Added To List'}}  </b>`
                }, {
                    type: 'warning',
                    allow_dismiss: !1,
                    label: "Cancel",
