	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			            ...
			            <ul class="nav nav-tabs justify-content-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#approved" role="tab" aria-selected="false">
                                    {{app()->getLocale() == 'ar' ? 'الادوية تم قبولها': 'Approved Drugs'}}
                                    <i class="now-ui-icons shopping_bag-16"></i>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active show" data-toggle="tab" href="#upapproved" role="tab" aria-selected="true">
                                    {{app()->getLocale() == 'ar' ? 'الادوية قيد الانتظار  ' : 'Upapproved Drugs' }}
                                    <i class="now-ui-icons shopping_bag-16"></i>
                                </a>
                            </li>
                        </ul>
			...
			<div class="modal-footer"> 
				<button type="button" class="btn btn-danger" data-dismiss="modal">{{__('profile.close')}}</button>
			</div>
		</div>
	</div>
</div>