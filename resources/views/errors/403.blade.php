...
<div>
    <h2 style="text-align: center;color: #FFF;font-size: 43px;position: fixed;width: 100%;">
        {{ $exception->getMessage() ?? 'من فضلك تأكد من تفعيل حسابك'}}
        <a href="{{route('getGroupPosts')}}" style="color:#999">للعودة</a>
    </h2>
    
</div>
<h1><a href="{{url('/')}}">Access Forbidden</a></h1>

{{Html::script('assets/js/pixi.js')}}
<script >
(function() {
    var lastTime = 0;
