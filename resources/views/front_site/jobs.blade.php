                                                            ...
                                                            <div class="card">
                                                                <div class="card-plain card-body">
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <form>
                                                                                        <div class="form-group">
                                                                                            <label> {{__('front.find_job')}}</label>
                                                                                            <input type="text"
                                                                                                   name="search"
                                                                                                   class="form-control text-left"
                                                                                                   autocomplete="off"
                                                                                                   placeholder="{{__('front.find_job_p')}}">
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <ul id="jobs">
                                                                                        @if(count($jobs) == 0)
                                                                                        <li style="width: 100%">
                                                                                            {{app()->getLocale() == 'ar' ? 'لا توجد بيانات': 'No Jobs'}}
                                                                                        </li>
                                                                                        @endif
                                                                                        @foreach($jobs as $job)
                                                                                            <li style="width: 100%">
                                                                                                ...
                                                                                                <p class="description">{{$job->contacts}}</p>
                                                                                                <button class="apply"
                                                                                                        data-info="{{$job}}"
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <img src="{{asset('front_assets/images/pharmacist-1.png')}}"
