...
$(document).ready(function () {
    $('[data-toggle="tooltip"], [rel="tooltip"]').tooltip(),  768 <= $(window).width() && 0 != (big_image = $('.header[data-parallax="true"]')).length && $(window).on("scroll", nowuiKit.checkScrollForParallax), $('[data-toggle="popover"]').each(function () {
