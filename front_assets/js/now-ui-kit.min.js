...
$(document).ready(function () {
    ...
    }), 992 <= $(window).width() && (big_image = $('.page-header-image[data-parallax="true"]'), $(window).on("scroll", nowuiKit.checkScrollForParallax)),  0 != $(".datetimepicker").length && $(".datetimepicker").datetimepicker({
        icons: {
