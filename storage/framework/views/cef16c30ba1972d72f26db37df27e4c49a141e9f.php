...
<?php echo e(Html::script('assets/js/prefixfree.min.js')); ?>
...
<body>
<div>
    <h2 style="text-align: center;color: #FFF;font-size: 43px;position: fixed;width: 100%;">
        <?php echo e($exception->getMessage() ?? 'من فضلك تأكد من تفعيل حسابك'); ?>

        <a href="<?php echo e(route('getGroupPosts')); ?>" style="color:#999">للعودة</a>
    </h2>
    
</div>
<h1><a href="<?php echo e(url('/')); ?>">Access Forbidden</a></h1>

<?php echo e(Html::script('assets/js/pixi.js')); ?>
...
renderer.view.id = "Permission Denied";
...
function positionText() {
    ...
    context.fillText("Access Denieds", 0, 80);
