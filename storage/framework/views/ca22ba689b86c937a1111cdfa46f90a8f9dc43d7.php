    ...
    <div class="container-fluid">
        <div class="button-container" style="margin-top: -121px">
            <ul class="list-unstyled list-inline ">
                ...
                <li class="list-inline-item">
                    ...
                    <h4 class="mt-1 cart-active"><?php echo e(__('pharmacy.shipping')); ?>    </h4>
                </li>
                <li class="list-inline-item">
                    <div class="cart-path">
        ...
        <div class="row mt-3">
            <div class="col-md-2 p-0">
                <?php if(in_array('payment',(array)$allowed_ads)): ?>
            ...
            <div class="col-md-8 text-center mt-4">
                <?php echo $__env->make("pages.shopping.shipping.templates.center_side", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <div class="col-md-2 p-0">
                <?php if(in_array('payment',(array)$allowed_ads)): ?>
