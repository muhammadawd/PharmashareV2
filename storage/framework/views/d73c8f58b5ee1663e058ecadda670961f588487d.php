<?php $__env->startSection('styles'); ?>
    ...
    <?php echo e(Html::style('assets/css/intlTelInput.min.css')); ?>

    <?php echo e(Html::style('assets/css/mobiledemo.css')); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <img src="<?php echo e(asset('assets/img/register_pattern2.png')); ?>" class="messages-img" alt="">
            ...
            <div class="row direction margin-form">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="<?php echo e(old('username')); ?>" class="form-control text-left"
                               autocomplete="off"
                               placeholder="<?php echo e(__('auth.username')); ?>  ">
                    </div> 
                        <span id="username" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('username') ?? null); ?></span> 
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label> <?php echo e(__('auth.phone')); ?> </label>
                        <input type="hidden" id="prefixs" name="prefix" autocomplete="off">
                        <input type="tel" id="phones" name="phone" dir="ltr" class="form-control text-left" value="<?php echo e(old('phone')); ?>"
                               autocomplete="off">
                    </div> 
                        <span id="phone" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('phone') ?? null); ?></span> 
                        <span id="prefix" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('prefix') ?? null); ?></span> 
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label> <?php echo e(__('auth.firstname')); ?>  </label>
                        <input type="text" name="firstname" value="<?php echo e(old('firstname')); ?>" class="form-control text-left"
                               autocomplete="off"
                               placeholder="<?php echo e(__('auth.firstname')); ?>">
                    </div> 
                        <span id="firstname" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('firstname') ?? null); ?></span> 
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label> <?php echo e(__('auth.lastname')); ?>  </label>
                        <input type="text" name="lastname" value="<?php echo e(old('lastname')); ?>" class="form-control text-left"
                               autocomplete="off"
                               placeholder="<?php echo e(__('auth.lastname')); ?>">
                    </div> 
                        <span id="lastname" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('lastname') ?? null); ?></span> 
                </div>
                <div class="col-md-6 col-6">
                    <div class="form-group">
                        ...
                        <span id="password" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('password') ?? null); ?></span> 
                </div>
                <div class="col-md-6 col-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" value="<?php echo e(old('email')); ?>" class="form-control text-left"
                               autocomplete="off"
                               placeholder="<?php echo e(__('auth.email')); ?>">
                    </div> 
                        <span id="email" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('email') ?? null); ?></span> 
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label> <?php echo e(__('auth.user_type')); ?> </label>
                        <select name="role_id" class="form-control" id="role_select">
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($role->role != "admin"): ?>
                                    <option value="<?php echo e($role->id); ?>" <?php if($role->id == old('role_id')): ?> selected <?php endif; ?>><?php echo e($role->title); ?></option>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select> 
                            <span id="role_id" style="top: -10px;position: relative;"
                                  class="text-danger"><?php echo e($errors->first('role_id') ?? null); ?></span> 
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label>  <?php echo e(__('auth.full_address')); ?></label>
                        <input type="text" name="full_address" value="<?php echo e(old('full_address')); ?>" class="form-control text-left"
                               autocomplete="off"
                               placeholder="<?php echo e(__('auth.full_address')); ?>">
                    </div> 
                        <span id="full_address" style="top: -10px;position: relative;"
                              class="text-danger"><?php echo e($errors->first('full_address') ?? null); ?></span> 
                </div>
                ...
                <div class="col-md-12 text-center mt-2">
                    <button id="submit_step" type="submit" class="btn btn-main btn-round text-white">
                        <?php echo e(__('auth.complete_step1')); ?>
    ...
    <div class="page-header header-filter register-part-one" filter-color="purple"
        ...
        <div class="row form-content" dir="rtl"
            ...
            <!--<div class="col-md-5">-->
            <!--    <div style="background: url('<?php echo e(asset("assets/img/facebookgoogle.jpg")); ?>') center center no-repeat;position: absolute;width: 30px;height: 30px;background-size: cover;top: 12px;left: 80px;background-position: -23px 2px;"></div>-->
            <!--    <button class="btn btn-default bg-white" style="min-width:80%;color:#000;text-align: right">-->
            <!--        <?php echo e(__('auth.login_gmail')); ?>-->
            <!--    </button>-->
            <!--</div>-->
            <!--<div class="col-md-5">-->
            <!--    <div style="background: url('<?php echo e(asset("assets/img/facebookgoogle.jpg")); ?>') center center no-repeat;position: absolute;width: 30px;height: 30px;background-size: cover;top: 12px;left: 80px;background-position: 6px 2px;"></div>-->
            <!--    <button class="btn btn-default bg-white" style="min-width:80%;color:#000;text-align: right">-->
            <!--        <?php echo e(__('auth.login_facebook')); ?>-->
            <!--    </button>-->
            <!--</div>-->
        </div>
...
<?php $__env->startSection('scripts'); ?>
    <?php echo e(Html::script('assets/js/jquery.min.js')); ?>

    <?php echo e(Html::script('assets/js/intlTelInput.min.js')); ?>

    <?php echo e(Html::script('assets/js/utils.js')); ?>
    ...
    <script>
        ...
        $("#form").submit(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('handleRegister')); ?>",
                type: "post",
                cache: false,
                dataType: 'json',
                processData: false,
                ...
                success: function (response) { 
                    ...
                    if (response.status) {
                        setTimeout(function () {
                            window.location.href = "<?php echo e(route('getRegisterView2')); ?>"+"/"+response.data.user.id;
                        }, 1000);
                    } else {
        ...
        $('#role_select').change(function(e){
            ...
            if (role == 4){
                ...
                $('#stepper').fadeIn();
                $('#submit_step').text('<?php echo e(__('auth.complete_step1')); ?>');
            }
        });
    </script>
<?php $__env->stopSection(); ?>
