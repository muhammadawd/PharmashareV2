...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.offers.approveOffers.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.offers.approveOffers.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
        ...
        function approve(id) {
            swal({
                ...
                if (result) {
                    $.ajax({
                        method: 'post',
                        url: '<?php echo e(route('approveAds')); ?>',
                        data: {
        ...
        function reject(id) {
            swal({
                ...
                if (result) {
                    $.ajax({
                        method: 'post',
                        url: '<?php echo e(route('rejectAds')); ?>',
                        data: {
                            _token: '<?php echo e(csrf_token()); ?>',
                            id: id
                        },
