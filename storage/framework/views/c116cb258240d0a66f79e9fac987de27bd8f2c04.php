...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.setting.storeBlocklist.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.setting.storeBlocklist.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
        ...
        function unblock(pharmacy_id) {
            swal({
                ...
                if (result) {
                    $.ajax({
                        method: 'post',
                        url: '<?php echo e(route('unblockPharmacy')); ?>',
                        data: {
