...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.admin.all-products.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.admin.all-products.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.admin.all-products.templates.select_show_modal", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
...
<?php $__env->startSection("scripts"); ?>
    ...
    <script>
        ...
        function checkAll() {
            $('.selected_drugs').each(function (index, input) {
                if (input.checked) {
                    input.checked = false
                } else {
                    input.checked = true
        ...
        function removeItem(id) {
            swal({
                ...
                if (result) {
                    $.ajax({
                        method: 'delete',
                        url: '<?php echo e(route('deleteAdminProduct')); ?>',
                        data: {
