<ul class="nav nav-pills nav-pills-primary flex-column">
    <?php if($user->role_id == 2): ?>
        <li class="nav-item">
            <a class="nav-link <?php if($nav == 7): ?> active show <?php endif; ?>" href="<?php echo e(route('getFilterPointsView')); ?>">
    ...
    <?php if($user->role_id == 1): ?>
        <li class="nav-item">
            <a class="nav-link <?php if($nav == 8): ?> active show <?php endif; ?>" href="<?php echo e(route('getAdminFilterPointsView')); ?>">
                <?php echo e(__('store.client_points')); ?>
