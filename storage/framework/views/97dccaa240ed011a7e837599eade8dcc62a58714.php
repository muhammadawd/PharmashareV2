...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.offers.editImageOffers.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.offers.editImageOffers.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
        ...
        $(document).ready(function () {
            ...
            $('#form').submit(function (e) {
                ...
                var formData = new FormData(form);
                    formData.append('ad_id', '<?php echo e(request()->id); ?>');
                ...
                setTimeout(() => {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('uploadUpdateImagesAds')); ?>',
                        method: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function (response) {
                            ...
                            if (response.status) {
                                ...
                                globalAddNotify('<?php echo e(__('settings.add_success')); ?>', 'success');
                                setTimeout(() => {
                                    location.reload();
                                }, 1000);
                            } else {
