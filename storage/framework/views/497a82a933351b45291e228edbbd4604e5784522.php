    ...
    <div class="register-part-two">
        ...
        <div class="form-content">
            ...
            <div class="row direction margin-form">
                            ...
                            <div class="form-group">
                                <label>  
                                    ...
                                    <?php elseif($user->role_id == 2): ?>
                                        <?php echo e(__('auth.store_license')); ?> 
                ...
                <div class="col-md-4">
                    <img src="<?php echo e(asset('assets/img/pharmacist-1.png')); ?>" alt="">
                </div>
                <div class="col-md-12 text-center mt-2">
                    <button id="submit_step" type="submit" class="btn btn-main btn-round text-white">
                        <?php echo e(__('auth.complete_step3')); ?>

                    </button>
                    <div class="col-md-12">
                        <div class="btn-group" style="display: flex;flex: 1">
                            <a href="<?php echo e(route('getGroupPosts')); ?>" class="btn btn-default bg-white"
