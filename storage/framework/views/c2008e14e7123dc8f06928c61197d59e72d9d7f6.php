...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.offers.addOfferPackages.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.offers.addOfferPackages.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
