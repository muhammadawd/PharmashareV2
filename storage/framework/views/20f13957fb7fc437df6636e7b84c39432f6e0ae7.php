...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.offers.addImageOffers.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.offers.addImageOffers.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
        ...
        $(document).ready(function () {
            ...
            $('#form').submit(function (e) {
                ...
                setTimeout(() => {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('uploadImagesAds')); ?>',
                        method: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
