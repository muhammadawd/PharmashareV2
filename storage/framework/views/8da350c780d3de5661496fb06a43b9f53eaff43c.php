...
<?php $__env->startSection("body"); ?>
    ...
    <div class="wrapper">
        <?php echo $__env->make("pages.offers.offerPackages.templates.top_header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make("pages.offers.offerPackages.templates.center_content", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
...
<?php $__env->startSection("scripts"); ?>
    ...
    <script>
        ...
        function deleteAdsPackage(id) {
            swal({
                ...
                if (result) {
                    $.ajax({
                        method: 'delete',
                        url: '<?php echo e(route('deleteAdsPackage')); ?>',
                        data: {
        ...
        function deleteAdsImagePackage(id) {
            swal({
                title: '<?php echo e(__('settings.warning')); ?>',
                text: '<?php echo e(__('settings.are_you_sure')); ?>',
                type: 'warning',
                ...
                if (result) {
                    $.ajax({
                        method: 'delete',
                        url: '<?php echo e(route('deleteAdsImagePackage')); ?>',
                        data: {
                            _token: '<?php echo e(csrf_token()); ?>',
                            id: id
                        },
