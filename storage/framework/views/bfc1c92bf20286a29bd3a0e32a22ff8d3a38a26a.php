    ...
    <div class="container-fluid">
        <div class="button-container" style="margin-top: -121px">
            <ul class="list-unstyled list-inline ">
                <li class="list-inline-item">
                    ...
                    <h4 class="mt-1"><?php echo e(__('pharmacy.cart')); ?>  </h4>
                </li>
                <li class="list-inline-item">
                    <div class="cart-path">
                ...
                <li class="list-inline-item">
                    ...
                    <h4 class="mt-1 cart-active"><?php echo e(__('pharmacy.checkout')); ?>   </h4>
                </li>
            </ul>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-2 p-0">
                <?php if(in_array('checkout',(array)$allowed_ads)): ?>
            ...
            <div class="col-md-8 text-center mt-4">
                <?php echo $__env->make("pages.shopping.checkout.templates.center_side", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <div class="col-md-2 p-0">
                <?php if(in_array('checkout',(array)$allowed_ads)): ?>
